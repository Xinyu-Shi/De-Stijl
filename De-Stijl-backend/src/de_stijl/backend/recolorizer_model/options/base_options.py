import argparse
import os
from de_stijl.backend.recolorizer_model.util import util
import torch
from de_stijl.backend.recolorizer_model import models
from de_stijl.backend.recolorizer_model import data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--resize_or_crop', type=str, default='resize', help='scaling and cropping of images at load time [resize_and_crop|crop|scale_width|scale_width_and_crop]')
        ...
        parser.add_argument('--sample_Ps', type=int, nargs='+', default=[10], help='patch sizes')
